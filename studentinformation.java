...
public class studentinformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentinformation.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Session", "Department", "Contact"
            }
        ) {
        ...
        if (studentinformation.getColumnModel().getColumnCount() > 0) {
            ...
            studentinformation.getColumnModel().getColumn(1).setResizable(false);
            studentinformation.getColumnModel().getColumn(1).setPreferredWidth(50);
            studentinformation.getColumnModel().getColumn(2).setResizable(false);
            studentinformation.getColumnModel().getColumn(2).setPreferredWidth(40);
